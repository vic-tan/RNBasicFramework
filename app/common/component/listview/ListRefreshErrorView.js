...
export default class ListRefreshErrorView extends Component {
        ...
        switch (this.props.childViewState) {
            ...
            case ListDataErrorConstant.CHILD_VIEW_STATE_NO_DATA://暂无数据
                return (
                    <TouchableOpacity style={styles.containerLayout} onPress={this.reRefresh.bind(this)}>
                        <View style={styles.containerLayout} >
                            <Image source={require('../../../../assets/img/com_prompt_no_data_icon.png')} style={styles.image}/>
                        </View>
                    </TouchableOpacity>
                );
                break;
            case ListDataErrorConstant.CHILD_VIEW_STATE_NET_WORK_ERROR://网络异常
                return (
                    <TouchableOpacity style={styles.containerLayout} onPress={this.reRefresh.bind(this)}>
                        <View style={styles.containerLayout} >
                            <Image source={require('../../../../assets/img/com_prompt_dail_icon.png')} style={styles.image}/>
                        </View>
                    </TouchableOpacity>
                );
                break;
            case ListDataErrorConstant.CHILD_VIEW_STATE_LOADING_ERROR://4.加载失败重试
                return (
                    <TouchableOpacity style={styles.containerLayout} onPress={this.reRefresh.bind(this)}>
                        <View style={styles.containerLayout}>
                            <Image source={require('../../../../assets/img/com_prompt_service_err_icon.png')} style={styles.image}/>
                        </View>
                    </TouchableOpacity>
                );
                break;
